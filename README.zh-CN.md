...
> 学术入口：母论文已提交 [SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6708819)（Abstract ID **6708819**，SSRN 审核中，页面当前显示标准 "under review" 提示，审核通过后展示完整 abstract）+ arXiv（Submission ID **7549904**，cs.AI，on hold 等 moderation）。当前入口见 [AKM Mother Paper](./papers/akm/README.md)
...
- SSRN [`abstract_id=6708819`](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6708819)（SSRN 审核中；当前页面显示 "under review" 提示，审核通过后展示完整 abstract）
...
| 分支 | SSRN | 状态 |
|---|---|---|
| [DaE](./branches/dae/paper/README.md) | [`6708998`](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6708998) | 审核中 |
| [Fitness](./branches/fitness/paper/README.md) | [`6709039`](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6709039) | 审核中 |
| [Fashion](./branches/fashion/paper/README.md) | [`6709078`](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6709078) | 审核中 |
...
- AKM 母定义：已完成
- AKM 母论文 / DaE / Fitness / Fashion：均已提交 SSRN，4 个 abstract URL 已在「研究入口」给出（当前 SSRN 审核中，页面显示 under review 提示，审核通过后展示完整 abstract）；母论文同步提交 arXiv（cs.AI，Submission ID 7549904，on hold 等 moderation）
