<!--
文件：references.md
核心功能：记录 Fitness 分支论文使用的外部参考文献及其本地依据文件。
输入：已下载的开放文献 PDF、PubMed 官方页面快照与论文正文引用需求。
输出：供写作、核对和后续 LaTeX 转换使用的参考文献清单。
-->

# Fitness Paper References
...
Basis downloaded: `references/foster-2017-monitoring-training-loads-pubmed.html`
Canonical URL: https://pubmed.ncbi.nlm.nih.gov/28253038/
...
Basis downloaded: `references/shattock-2022-autoregulation-subjective-vs-objective-pubmed.html`
Canonical URL: https://pubmed.ncbi.nlm.nih.gov/32058357/
...
Basis downloaded: `references/haddad-2017-session-rpe-training-load.pdf`
Canonical URL: https://www.frontiersin.org/journals/neuroscience/articles/10.3389/fnins.2017.00612/full
